...
$.extend(true, DataTable.defaults, {
    dom:
        ...
        "<'my-2 col-span-2 rounded min-w-full'tr>" +
        "<'self-center'i>" +
...
$.extend(DataTable.ext.classes, {
    ...
    sFilterInput: "input input-bordered w-full max-w-xs",
    sLengthSelect: "select select-bordered max-w-xs",
    sProcessing: "dt-processing uk-panel",
    tailwindcss: {
        paging: {
            active: 'bg-base-100',
            notActive: '',
            button: 'btn leading-6 hover:z-10 focus:z-10 active:z-10 inline-flex justify-center items-center',
            first: 'btn',
            last: 'btn',
        ...
        thead: {
            row: 'border-b text-lg',
            cell: 'px-3 py-4 font-semibold text-left'
        },
        tbody: {
            row: 'even:bg-base-100',
            cell: 'p-3'
        },
        tfoot: {
            row: 'even:bg-base-100',
